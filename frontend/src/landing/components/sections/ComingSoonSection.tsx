...
export function ComingSoonSection() {
  return (
    <section
      id='proximamente'
      className='py-[72px] pb-[86px] bg-[linear-gradient(180deg,#ffffff_0%,var(--color-mint-soft-2)_100%)]'
    >
      <div className='container-x'>
        <FadeInOnScroll className='rounded-[30px] border border-mint-line bg-[linear-gradient(145deg,#ffffff,var(--color-mint-soft))] px-7 py-[54px] text-center shadow-soft'>
