export function Logo() {
  return (
    ...
    >
      <svg viewBox='0 0 92 42' aria-hidden='true' className='h-[28px] w-[45px]'>
        <path
        ...
        />
        <circle cx='74' cy='22' r='2.1' fill='#35BFA6' />
        <circle cx='82' cy='22' r='2.1' fill='#35BFA6' />
        <circle cx='90' cy='22' r='2.1' fill='#35BFA6' />
      </svg>
