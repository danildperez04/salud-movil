...
> = {
  ...
  indicadores: {
    ...
    list: ['Registro de indicadores', 'Rangos visuales', 'Historial y evolución'],
...
export const teamMembers = [
  ...
  },
  {
    duck: 'Backend Duck',
    name: 'Danild Pérez',
    role: 'Scrum Master y Desarrollador Backend',
  ...
  },
  {
    ...
    name: 'Julio Reyes',
    role: 'Desarrollador Frontend, Diseñador UX y Analista de Datos',
